...
public class DtoMapper {
    ...
    thread.setUserId(dto.getUserId());
    ...
    public static SubThreadDto toDto(SubThread subThread) {
        ...
        if (subThread.getUserId() != null) {
            try {
                dto.setUserId(Long.valueOf(subThread.getUserId()));
    ...
    // For toEntity, you must set Thread and userId externally (service/controller)
    ...
    public static MessageDto toDto(Message message) {
        ...
        if (message.getUserId() != null) {
            try {
                dto.setUserId(Long.valueOf(message.getUserId()));
            } catch (NumberFormatException e) {}
        }
    ...
    public static Message toEntity(MessageDto dto, SubThread subThread) {
        ...
        if (dto.getUserId() != null) {
            message.setUserId(String.valueOf(dto.getUserId()));
        }
    ...
    public static MessageVoteDto toDto(MessageVote vote) {
        ...
        if (vote.getUserId() != null) {
            try {
                dto.setUserId(Long.valueOf(vote.getUserId()));
            } catch (NumberFormatException e) {}
        }
    ...
    public static MessageVote toEntity(MessageVoteDto dto) {
        ...
        if (dto.getUserId() != null) {
            vote.setUserId(String.valueOf(dto.getUserId()));
        }
