...
('admin_user', 'Welcome to the forum! I am the administrator.', 'model_admin_001', 'ADMIN', NOW()),
('john_doe', 'Hi everyone! Happy to be part of this community.', 'model_user_002', 'CITIZEN', NOW()),
('jane_smith', 'Looking forward to great discussions!', 'model_user_003', 'CITIZEN', NOW()),
('car_enthusiast', 'Love talking about vehicles and technology.', 'model_user_004', 'CITIZEN', NOW()),
('tech_guru', 'Here to help with technical questions.', 'model_user_005', 'CITIZEN', NOW()),
('developer_mike', 'Passionate about coding and software development.', 'model_user_006', 'CITIZEN', NOW()),
('auto_expert', 'Professional mechanic with 15 years of experience.', 'model_user_007', 'CITIZEN', NOW()),
('forum_moderator', 'Here to keep discussions friendly and helpful.', 'model_mod_001', 'ADMIN', NOW()),
('admin', 'admin user', 'M1', 'ADMIN', NOW()),
('user1', 'regular user', 'M1', 'CITIZEN', NOW())
ON CONFLICT (username) DO NOTHING;

-- Threads (fragile: assumes inserted user ids start at 1..10)
